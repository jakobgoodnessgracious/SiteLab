        ...
        <div class="wrapper">
            ...
            <div class="container-fluid" id="contentmargintop" >
                ...
                <div class="container-fluid">
                    ...
                    <div class="row-fluid">
                        <div class="col-xs-12 text-center">
                            <p id="labelemulator">Please select a Unit Type from the drop-down menu:</p>
                        </div>
                    </div>
                </div>
            ...
            <h4 class="text-center">Results</h4>
                ...
                <div class="row-fluid">
            <hr style="margin-left: 33.33%;" width="33.33%"> 

            <div class="container" class="containerMargin">
                <div class="row" id="moveright">
                    <div class="col-xs-12 text-center h4">
                        You have converted from: <c:out value="${convertFrom}" />
                    </div>
                </div>
                <div class="row" id="moveright">
                    <div class="col-xs-12 text-center h4">
                        Value: <c:out value="${convertFromSymbol}" /><c:out value="${unitNumber}" /> <c:out value="${convertFromDenotation}" /> 
                    </div>
                </div>
            </div>
            ...
            <div class="container" class="containerMargin">
                <div class="row" id="moveright">
                    <div class="col-xs-12 text-center h4">
                        You have converted to: <c:out value="${convertTo}" />
                    </div>
                </div>
            </div>
            ...
            <div class="container" class="containerMargin">
                <div class="row" id="moveright">
                    <div class="col-xs-12 text-center h4">
                        Value: <c:out value="${convertToSymbol}" /><c:out value="${result}" /> <c:out value="${convertToDenotation}" />
                    </div>
                </div>
            </div>
                </div>
